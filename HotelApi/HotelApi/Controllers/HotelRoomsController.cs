...
namespace HotelApi.Controllers
{
    public class HotelRoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Rate,PetFriendly,Amenities")] HotelRoom hotelRoom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Rate,PetFriendly,Amenities")] HotelRoom hotelRoom)
        {
            if (id != hotelRoom.Id)
            {
                return NotFound();
