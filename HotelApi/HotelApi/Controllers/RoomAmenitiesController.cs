...
namespace HotelApi.Controllers
{
    public class RoomAmenitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Layout,Amenities,Room")] RoomAmenities roomAmenities)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Layout,Amenities,Room")] RoomAmenities roomAmenities)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!RoomAmenitiesExists(roomAmenities.Id))
                    {
                        return NotFound();
                    }
                    else
